...
class TemeDetailsHistoryScreen extends StatefulWidget {
  const TemeDetailsHistoryScreen({Key? key}) : super(key: key);

  @override
  State<TemeDetailsHistoryScreen> createState() => _TemeDetailsHistoryScreenState();
}

class _TemeDetailsHistoryScreenState extends State<TemeDetailsHistoryScreen> {
  @override
                ...
                Container(
                  ...
                  child: TabBar(
                    indicator: BoxDecoration(
                        color: greenColor, borderRadius: BorderRadius.circular(25.0)),
