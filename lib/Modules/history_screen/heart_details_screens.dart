...
class HeartDetailsHistory extends StatefulWidget {
  const HeartDetailsHistory({Key? key}) : super(key: key);
  @override
  _HeartDetailsHistory createState() => _HeartDetailsHistory();
}

class _HeartDetailsHistory extends State<HeartDetailsHistory> {
  @override
